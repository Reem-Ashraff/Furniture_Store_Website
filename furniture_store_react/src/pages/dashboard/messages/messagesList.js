                    ...
                    <main className="category-main content">
                        ...
                        <section>
                            <div className="d-flex justify-content-between align-items-center dash-head">
                                <h3>Messages <span>( {msgs.length} {msgs.length > 1 ? "messages" : "message"} )</span></h3>
                                {/* <div>
                            ...
                            <div className="d-flex justify-content-center">
                                ...
                                <table>
                                    <thead>
                                        <tr>
                                            {/* <th className=""></th> */}
                                            <th className="col-4 order-code">Email</th>
                                        ...
                                        {msgs.map((message) => {
                                            return (
                                                <tr key={message.id}>
                                                    ...
                                                    <td className="order-code">{message.email}</td>
